    ...
    with patch("loquilex.api.supervisor.Session.start"):
        with patch("subprocess.Popen") as mock_popen:
            ...
            with TestClient(app) as client:
                    ...
                    async with websockets.connect(ws_url) as websocket:
                        ...
                        hello_envelope = WSEnvelope(
                            ...
                            data=ClientHelloData(
                                ...
                                accept=[MessageType.ASR_PARTIAL, MessageType.ASR_FINAL, MessageType.STATUS],
                                max_in_flight=16
                            ).model_dump()
                        )
                        ...
                        ack_envelope = WSEnvelope(
                            ...
                            data=AckData(ack_seq=0).model_dump()
                        )
                ...
                except (websockets.exceptions.InvalidURI, OSError, asyncio.TimeoutError, ConnectionError) as e:
