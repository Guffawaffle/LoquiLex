...
class TestASRMetrics:
    ...
    def test_partial_event_tracking(self):
        ...
        with patch('time.monotonic') as mock_time, patch('time.time') as mock_wall_time:
            ...
            times = [start_time + i * 0.1 for i in range(10)]  # Enough values
    ...
    def test_summary_generation(self):
        ...
        partial1 = {"type": "asr.partial", "text": "hello", "words": [], "seq": 1, "segment_id": "seg1"}
        final1 = {"type": "asr.final", "text": "hello world.", "words": [], "eou_reason": "punctuation", "segment_id": "seg1"}
    ...
    def test_performance_targets(self):
        ...
        with patch('time.monotonic') as mock_time, patch('time.time') as mock_wall_time:
            ...
            times = [base_time + i * 0.1 for i in range(10)]
            mock_time.side_effect = times
            mock_wall_time.return_value = 1000.0
            
            partial1 = {"type": "asr.partial", "text": "hello", "words": [], "seq": 1, "segment_id": "seg1"}
            partial2 = {"type": "asr.partial", "text": "hello world", "words": [], "seq": 2, "segment_id": "seg1"}
            final1 = {"type": "asr.final", "text": "hello world.", "words": [], "eou_reason": "punctuation", "segment_id": "seg1"}
