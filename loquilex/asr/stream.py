...
__all__ = ["StreamingASR", "ASRWord", "ASRSegment", "ASRPartialEvent", "ASRFinalEvent", "ASRSnapshotEvent"]
...
class StreamingASR:
    ...
    def __init__(self, stream_id: Optional[str] = None) -> None:
        ...
        print(f"[StreamingASR] Initialized: device={device} model={self.model_name} compute={self.effective_compute}")
        ...
        for seg in segments:
            ...
            for word_obj in seg_words:
                ...
                try:
                    ...
                    confidence = float(getattr(word_obj, "probability", 0.8) or 0.8)  # default confidence
                except Exception:
            ...
            try:
                ...
                if text:
                    ...
                    live_partial = {
                        "segment_id": self.current_segment_id,
                        "text": text,
                        "words": [{"w": w.w, "t0": w.t0, "t1": w.t1, "conf": w.conf} for w in words],
                        "seq": self.seq_counter,
                    }
