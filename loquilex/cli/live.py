"""DEPRECATED: Legacy CLI orchestrator for live captioning with translation.
...
LANGUAGE SUPPORT:
- Now supports ANY language pair via --src-lang and --tgt-lang flags
- Default: English to Chinese (--src-lang en --tgt-lang zh)
- Supports 200+ languages via NLLB-200 or 100+ via M2M-100
- See MIGRATION.md for language codes and examples
...
def main() -> int:
    warnings.warn(
        "loquilex.cli.live is deprecated for orchestration. "
