"""CTranslate2 provider for NLLB models."""
...
from ..tokenizers.nllb import NLLBTokenizerAdapter


class CT2NLLBProvider:
    """CTranslate2 provider for NLLB models."""
    ...
    def __init__(self):
        ...
        if not self._model_dir:
            raise MTModelLoadError(
                "LX_MT_MODEL_DIR environment variable required: must be set to the path of converted CTranslate2 model files"
            )
    ...
    def _load_model(self):
        ...
        try:
            ...
            import ctranslate2 as ct2  # type: ignore[import-not-found]
        except ImportError:
        ...
        try:
            ...
            raise MTModelLoadError(f"Failed to load NLLB model: {e}")
...
def _create_ct2_nllb_provider() -> MTProvider:
    """Factory function for CT2 NLLB provider."""
    return CT2NLLBProvider()


# Register provider on module import
register_provider("ct2-nllb", _create_ct2_nllb_provider)